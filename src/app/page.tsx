...
export default function Home() {
  ...
  return (
    <main className="w-full h-full flex flex-col md:flex-row justify-between">
      ...
      <section className="flex justify-between items-center w-full mx-auto">
        <div className="flex flex-col justify-center items-end p-4 h-full w-1/2">
        ...
        <div className="h-full flex w-1/2">
          <motion.div
            className="flex justify-center items-center bg-blue-500 text-white font-bold w-24 h-24"
            animate={controls}
            style={{
              borderRadius: "50%",
            }}
